...
import { Category,Gettype,Submit,Confirm,Page} from '../../../voting/src/api/Auth';
          ...
          <div className="col-lg-3 col-md-3  mtx ">
            <div className='orginfo'>
              <div className='card'>
                ...
                <div className='countdownn'><Countdown date={contestDetails.data.countDown} /></div>
                <br/>
                      ...
                      <div className="progress">
                        <div
                          className={`progress-bar progress-bar-striped ${
                            (data.contestVolume / contestDetails.data.threshold) * 100 >=99
                              ? 'bg-success'
...
{/* start modal */}
  ...
  <div className="modal-dialog">
    ...
    <div className={`progress-bar progress-bar-striped ${
                            (ttype.contestVolume / contestDetails.data.threshold) * 100 >=99
                              ? 'bg-success'
